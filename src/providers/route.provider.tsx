...
export const RouteProvider = ({ children }: { children: ReactNode }) => {
  ...
  const adminRoles = useMemo(() => [UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.STAFF], []);

  useEffect(() => {
    if (isAuthenticating || !isAuthenticated || !pathname || !currentUser || !currentUser.role) {
      return;
    }
  ...
  }, [isAuthenticated, isAuthenticating, pathname, currentUser, adminRoles, router]);
