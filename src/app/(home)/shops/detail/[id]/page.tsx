    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/shops')}>Quay lại danh sách</Button>
        </div>
      </div>
    );
  }
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="flex flex-col items-center">
              <p className="text-gray-700 leading-relaxed">
                Nếu bạn không tìm thấy mẫu váy cưới ưng ý, chúng tôi cung cấp dịch vụ đặt may theo
                yêu cầu. Hãy cho chúng tôi biết ý tưởng của bạn và chúng tôi sẽ biến nó thành hiện
                thực.
              </p>
              <CreateCustomOrderDialog
                children={
                  <Button className="mt-4 bg-rose-600 hover:bg-rose-700">Đặt may ngay</Button>
                }
                shopId={shop.id}
              />
            </CardContent>
        ...
        <TabsContent value="about" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-700 leading-relaxed">
                Chào mừng bạn đến với {shop.name}! Chúng tôi là một trong những cửa hàng váy cưới uy
                tín, chuyên cung cấp các mẫu váy cưới đẹp và chất lượng cao. Với đội ngũ thiết kế
                giàu kinh nghiệm, chúng tôi cam kết mang đến cho bạn những chiếc váy cưới hoàn hảo
                cho ngày trọng đại.
              </p>
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">Dịch vụ chuyên nghiệp</h4>
                  <p className="text-sm text-gray-600">
                    Tư vấn và thiết kế váy cưới theo yêu cầu riêng của từng khách hàng
                  </p>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
