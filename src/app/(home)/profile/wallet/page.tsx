...
function WalletPageContent() {
  ...
  const [getMyWallet, { data: walletData, isLoading, error }] = useLazyGetMyWalletQuery();
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Không thể tải thông tin ví</h3>
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="text-center p-4 bg-blue-50 rounded-lg">
              ...
              <div className="text-sm text-gray-600 mb-3">Trạng thái bảo mật</div>
            ...
            <div className="text-center p-4 bg-purple-50 rounded-lg">
              <div className="text-lg font-semibold text-purple-600 mb-3">Thông tin ngân hàng</div>
              <div className="text-sm text-gray-600 mb-3">
                {wallet?.bin && wallet?.bankNumber ? (
                  <div className="space-y-1">
                    <div className="font-medium">
                      Ngân hàng:{' '}
                      {banks?.find((bank) => bank.bin === wallet.bin)?.shortName || wallet.bin}
                    </div>
                    <div className="font-medium">Số TK: {wallet.bankNumber}</div>
                  </div>
                ) : (
                  'Chưa cập nhật'
                )}
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Tìm hiểu cách sử dụng ví điện tử của bạn</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="withdraw">
          {wallet && <WithdrawTabs wallet={wallet} onWithdrawSuccess={handleWithdrawSuccess} />}
        </TabsContent>
