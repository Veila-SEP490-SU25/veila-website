      ...
      <Card className="w-full max-w-md mx-auto">
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-green-700 mb-2">Xác thực thành công!</h3>
            <p className="text-gray-600">Số điện thoại {phone} đã được xác thực thành công.</p>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardContent className="space-y-4">
        ...
        {!isCodeSent ? (
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">Nhấn vào reCAPTCHA để gửi mã xác thực</p>
          </div>
        ) : (
          <div className="space-y-4">
            <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600">Mã xác thực đã được gửi đến {phone}</p>
          </div>
        )}
