    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-4xl">
        ...
        <div className="space-y-4">
                  ...
                  {isUploading ? (
                    ...
                    <>
                      ...
                      <div className="text-center">
                        <p className="text-sm text-muted-foreground font-medium">Nhấn để chọn ảnh</p>
                        <p className="text-xs text-muted-foreground/70 mt-1">Tối đa {maxSizeInMB}MB</p>
                      </div>
                    </>
                  )}
                </div>
          ...
          {/* Upload Info */}
          <div className="text-center">
            <p className="text-xs text-muted-foreground">Hỗ trợ: JPG, PNG, GIF. Tối đa {maxSizeInMB}MB</p>
            {file && (
