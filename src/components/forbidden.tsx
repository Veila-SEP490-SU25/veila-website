      ...
      <CardContent className="p-8 md:p-12 text-center">
        ...
        <div className="mb-8 space-y-4">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-md mx-auto">
            Bạn không có quyền truy cập vào trang này. Vui lòng liên hệ quản trị viên hoặc đăng nhập
            với tài khoản có quyền phù hợp.
          </p>
        </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8">
          ...
          <p className="text-sm text-amber-700">
            Trang này yêu cầu quyền đặc biệt. Nếu bạn tin rằng đây là lỗi, vui lòng liên hệ với bộ
            phận hỗ trợ.
          </p>
        </div>
