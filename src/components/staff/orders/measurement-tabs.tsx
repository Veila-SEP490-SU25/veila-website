...
export const MeasurementsTab = ({
  ...
  const measurements = [
    {
      label: "Chiều cao",
      value: orderType === OrderType.CUSTOM ? orderService?.request.height : currentOrderDressDetail.height,
      unit: "cm",
      icon: <Ruler className="h-4 w-4 text-blue-500" />,
    },
    {
      label: "Cân nặng",
      value: orderType === OrderType.CUSTOM ? orderService?.request.weight : currentOrderDressDetail.weight,
      unit: "kg",
      icon: <Weight className="h-4 w-4 text-green-500" />,
    },
    {
      label: "Vòng ngực",
      value: orderType === OrderType.CUSTOM ? orderService?.request.bust : currentOrderDressDetail.bust,
      unit: "cm",
      icon: <User className="h-4 w-4 text-purple-500" />,
    },
    {
      label: "Vòng eo",
      value: orderType === OrderType.CUSTOM ? orderService?.request.waist : currentOrderDressDetail.waist,
      unit: "cm",
      icon: <Circle className="h-4 w-4 text-orange-500" />,
    },
    {
      label: "Vòng hông",
      value: orderType === OrderType.CUSTOM ? orderService?.request.hip : currentOrderDressDetail.hip,
      unit: "cm",
      icon: <Circle className="h-4 w-4 text-pink-500" />,
    },
    {
      label: "Nách",
      value: orderType === OrderType.CUSTOM ? orderService?.request.armpit : currentOrderDressDetail.armpit,
      unit: "cm",
      icon: <Shirt className="h-4 w-4 text-indigo-500" />,
    },
    {
      label: "Bắp tay",
      value: orderType === OrderType.CUSTOM ? orderService?.request.bicep : currentOrderDressDetail.bicep,
      unit: "cm",
      icon: <Muscle className="h-4 w-4 text-red-500" />,
    },
    {
      label: "Cổ",
      value: orderType === OrderType.CUSTOM ? orderService?.request.neck : currentOrderDressDetail.neck,
      unit: "cm",
      icon: <Circle className="h-4 w-4 text-teal-500" />,
    },
    {
      label: "Vai",
      value: orderType === OrderType.CUSTOM ? orderService?.request.shoulderWidth : currentOrderDressDetail.shoulderWidth,
      unit: "cm",
      icon: <Shirt className="h-4 w-4 text-cyan-500" />,
    },
    {
      label: "Tay áo",
      value: orderType === OrderType.CUSTOM ? orderService?.request.sleeveLength : currentOrderDressDetail.sleeveLength,
      unit: "cm",
      icon: <Shirt className="h-4 w-4 text-amber-500" />,
    },
    {
      label: "Dài lưng",
      value: orderType === OrderType.CUSTOM ? orderService?.request.backLength : currentOrderDressDetail.backLength,
      unit: "cm",
      icon: <Ruler className="h-4 w-4 text-emerald-500" />,
    },
    {
      label: "Eo thấp",
      value: orderType === OrderType.CUSTOM ? orderService?.request.lowerWaist : currentOrderDressDetail.lowerWaist,
      unit: "cm",
      icon: <Ruler className="h-4 w-4 text-violet-500" />,
    },
    {
      label: "Eo xuống sàn",
      value: orderType === OrderType.CUSTOM ? orderService?.request.waistToFloor : currentOrderDressDetail.waistToFloor,
      unit: "cm",
