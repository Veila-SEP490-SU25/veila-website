...
import { useCreateDressMutation, useGetCategoriesQuery } from "@/services/apis"
import { DressStatus, type IDressCreate } from "@/services/types"
...
export function CreateDressDialog({ trigger, onSuccess }: CreateDressDialogProps) {
  ...
  const [dressData, setDressData] = useState<IDressCreate>({
    categoryId: "",
    name: "",
    description: "",
    sellPrice: 0,
  ...
  const handleInputChange = (field: keyof IDressCreate, value: any) => {
    setDressData((prev) => ({
      ...prev,
      [field]: value,
    }))
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
              ...
              <div className="space-y-4">
                ...
                {dressData.isSellable && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("sellPrice", Number.parseInt(e.target.value) || 0)}
                    />
                  </div>
                )}
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">Cho phép khách hàng thuê váy này</p>
                  </div>
                  <Switch
                ...
                {dressData.isRentable && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("rentalPrice", Number.parseInt(e.target.value) || 0)}
                    />
                  </div>
                )}
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("bust", Number.parseInt(e.target.value) || 0)}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("waist", Number.parseInt(e.target.value) || 0)}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="0"
                      value={dressData.hip || ""}
                      onChange={(e) => handleInputChange("hip", Number.parseInt(e.target.value) || 0)}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button type="button" size="icon" onClick={addImageUrl} disabled={!newImageUrl.trim()}>
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t">
          ...
          <Button onClick={handleSubmit} disabled={isLoading} className="bg-rose-600 hover:bg-rose-700">
            {isLoading ? (
              <>
