...
import { MilestoneStatus, TaskStatus, type ICreateMilestone } from "@/services/types"
...
export function CreateMilestoneDialog({ orderId, milestoneCount = 0, onSuccess, trigger }: CreateMilestoneDialogProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Tạo một giai đoạn mới với các công việc cụ thể để theo dõi tiến độ đơn hàng.
          </DialogDescription>
        </DialogHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Ví dụ: Thiết kế và chuẩn bị" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Mô tả tổng quan về những gì sẽ được thực hiện trong giai đoạn này
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                {fields.map((field, index) => (
                  <Card key={field.id} className="border-l-4 border-l-blue-200">
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
                        <h4 className="font-medium text-base">Công việc #{index + 1}</h4>
                        {fields.length > 1 && (
                          <Button
                            type="button"
                            variant="ghost"
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="Ví dụ: May cổ áo" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
