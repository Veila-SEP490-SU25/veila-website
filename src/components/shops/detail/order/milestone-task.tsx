...
import { useCompleteTaskMutation, useLazyGetMilestoneTasksQuery } from '@/services/apis';
      ...
      <CollapsibleContent className="mt-3">
        {isLoading ? (
          ...
          <div className="space-y-3">
            ...
            {currentUser?.role === UserRole.SHOP && orderStatus !== 'IN_PROCESS' && (
              <CreateTaskDialog
          ...
          <Card className="flex items-center justify-center">
            {currentUser?.role === UserRole.SHOP && orderStatus !== 'IN_PROCESS' && (
              <CreateTaskDialog
                milestoneId={milestoneId}
                trigger={
                  <Button className="w-fit justify-start bg-transparent" variant="outline">
                    <Plus className="h-4 w-4 mr-2" />
                    Thêm công việc
                  </Button>
                }
